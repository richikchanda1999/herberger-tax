...
export type GetActiveStreamsQueryVariables = Exact<{
  sender: Scalars['String'];
  receiver: Scalars['String'];
}>;


export type GetActiveStreamsQuery = { __typename?: 'Query', streams: Array<{ __typename?: 'Stream', id: string }> };

export type GetFlowRateQueryVariables = Exact<{
  sender: Scalars['String'];
  receiver: Scalars['String'];
}>;


export type GetFlowRateQuery = { __typename?: 'Query', streams: Array<{ __typename?: 'Stream', id: string, currentFlowRate: any, updatedAtTimestamp: any, streamedUntilUpdatedAt: any }> };


export const GetActiveStreams = gql`
    query getActiveStreams($sender: String!, $receiver: String!) {
  streams(
    orderBy: createdAtTimestamp
    orderDirection: desc
    first: 1
    where: {receiver: $receiver, sender: $sender, currentFlowRate_gt: 0}
  ) {
    id
  }
}
    `;
export const GetFlowRate = gql`
